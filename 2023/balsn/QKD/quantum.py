...
class Basis(object):
    ...
    def measure(self, q:Qubit, verbose=False):
        ...
        if verbose:
            print(measured_bit, probability, collapased_qubit.v)
...
# print(PAULI_BASES[0].basis[0].v)
# print(PAULI_BASES[0].basis[1].v)
# print(PAULI_BASES[1].basis[0].v)
# print(PAULI_BASES[1].basis[1].v)