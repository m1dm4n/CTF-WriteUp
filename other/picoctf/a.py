...
known_segments = []
decrypted_flag = ""
ABC = "picoCTF}{bad_" + string.digits + string.ascii_letters
while "}" not in decrypted_flag:
    for c in ABC:
        ...
        current_encrypt_test = current_encrypt_test.replace(
            "Here you go: ", "")

        current_char_rep = remove_segments(
            current_encrypt_test, known_segments)
